...
+ (MCSMApplicationUUIDKeychainItem *)setApplicationUUIDKeychainItemWithUUID:(NSString *)uuid
{
    if (uuid) {
        MCSMApplicationUUIDKeychainItem *oldItem = [self applicationUUIDKeychainItem];
        if (oldItem) {
            [oldItem removeFromKeychainWithError:NULL];
        }
        return (MCSMApplicationUUIDKeychainItem *)[self genericKeychainItemWithService:MCSMApplicationUUIDKeychainItemService
                                                                               account:[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleIdentifier"]
                                                                            attributes:nil
